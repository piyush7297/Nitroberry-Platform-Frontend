                ...
                <Input
                  ...
                  onChange={(e) => {
                    const filteredValue = e.target.value
                      ...
                      .toUpperCase()
                      .slice(0, 5);
                    updateForm("templateCode", filteredValue);
                  }}
                />
              </div>
            </div>
              ...
              <div className="grid gap-3">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="font-medium mt-1 font-mono text-lg text-purple-600">{formData?.templateCode || 'Not set'}</p>
                  </div>
                  <div>
