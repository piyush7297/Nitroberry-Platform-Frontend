    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border bg-white p-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-semibold text-slate-900">Company Locations</h3>
              <p className="text-xs text-slate-500">
                Every location has a linked calendar where you can manage holidays and shifts.
              </p>
            </div>
          </div>
          <div>
      ...
      <div className="space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <p className="text-xs text-slate-500">{filteredLocations.length} locations</p>
        </div>
