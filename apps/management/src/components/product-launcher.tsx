...
const VAULT = process.env.NEXT_PUBLIC_VAULT_APP_URL ?? "";
...
const PRODUCTS: LauncherProduct[] = [
  ...
  },
  {
    ...
    homeHref: VAULT ? `${VAULT}/vault` : `${MAIN}/vault`,
  },
  {
    id: "social",
    name: "Social",
...
export function ProductLauncher() {
  return <ProductLauncherPopover products={PRODUCTS} activeProductId="management" />;
}
