...
// Maps backend field names → CSS custom property names.
// Add entries here as the backend introduces new theme fields.
const FIELD_MAP: Record<string, string> = {
    ...
    sidebar_foreground_color: "--sidebar-foreground",
};
